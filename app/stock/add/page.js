...
export default function addStock() {
  ...
  const { data: Data, error: Error, isLoading: IsLoading } = useGetItemsQuery();
  const [addStock, { isSuccess, isError, data }] = useAddStockMutation();
              ...
              >
                ...
                <div className="flex flex-col">
                  ...
                  <select
                    ...
                    value={item.items_id}
                    onChange={(e) =>
                      setItem({ ...item, items_id: e.target.value })
                    }
